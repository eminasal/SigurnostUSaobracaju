...
<!--Header-->
	...
	<br>
			<div class="edu_button">
				...
				<a class="btn btn-primary btn-lg hvr-underline-from-left" href="vidi.php" role="button">Vidi ID</a>
			</div>
	</div>
	...
	<!--//Header-->
		...
		<br> <br><br>
	<form  method="post" action="novi.php">
		

<div class="register-form">
<table>

 <p> Unesi id: </p><input type="text" name="s_id"><br/>

<tr>
<input type="submit" name="submit" value="Prikaži izvještaj" >
<tr>
<br>
